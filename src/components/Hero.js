...
function Hero() {
  return (
    <div className='pt-[120px]'>
      ...
      <div className='flex sm:flex justify-start items-center sm:justify-center sm:items-center '>
        <p className='pl-[24px] sm:p-0 font-semibold text-[56px] text-[#120055] leading-[65px]'>
          Sreemikil T Manorahan
        </p>
      </div>
      <div className='flex justify-start sm:flex sm:justify-center sm:items-center sm:text-center'>
        <p className=' sm:text-center text-left px-[24px] pt-[24px] sm:pt-[36px]  font-normal max-w-[880px] text-[20px] text-black opacity-[64%]'>
